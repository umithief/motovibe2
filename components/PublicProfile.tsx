...
import { Trophy, Calendar, MapPin, Bike, UserPlus, MessageCircle, Share2, Grid, ArrowLeft, Shield } from 'lucide-react';
...
const generateMockGarage = (): UserBike[] => [
    { id: 101, brand: 'Yamaha', model: 'R6', year: '2020', km: '15.000', color: 'Mavi', image: 'https://images.unsplash.com/photo-1568772585407-9361f9bf3a87?q=80&w=800&auto=format&fit=crop' },
    { id: 102, brand: 'Honda', model: 'CBR650R', year: '2022', km: '5.000', color: 'Kırmızı', image: 'https://images.unsplash.com/photo-1591637333184-19aa84b3e01f?q=80&w=800&auto=format&fit=crop' }
];
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    {garage.map((bike) => (
                                        <motion.div 
                                            ...
                                            className="group bg-white dark:bg-[#111] rounded-2xl overflow-hidden border border-gray-200 dark:border-white/10 hover:border-moto-accent/50 transition-all hover:shadow-lg"
                                        >
