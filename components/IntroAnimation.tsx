            ...
            {step === SEQUENCE.length && !isExit && (
                ...
                >
                    <div className="mb-6 relative">
                        <div className="absolute inset-0 bg-moto-accent blur-[40px] opacity-20"></div>
                        <Zap className="w-20 h-20 text-moto-accent fill-moto-accent relative z-10" />
                    </div>
                    <h1 className="text-5xl font-display font-bold text-white tracking-tighter">
                        MOTO<span className="text-moto-accent">VIBE</span>
                    </h1>
                    <div className="mt-4 h-[2px] w-12 bg-white/20 rounded-full"></div>
                </motion.div>
            )}
